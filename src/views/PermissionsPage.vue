  ...
  },
  {
    ...
    rows: [
      { action: 'Просмотр', cells: { admin: { label: 'все' }, dp: { label: 'все' }, rp: { label: 'своих проектов' }, vp: { label: 'своих процессов' }, worker: empty } },
      {
        ...
        cells: {
          admin: { label: 'да' },
          dp: { label: 'да', hint: 'к задачам, которые видит' },
          rp: { label: 'да', hint: 'к задачам своих проектов' },
          vp: { label: 'да', hint: 'к задачам своих процессов' },
          worker: empty,
        },
      },
      {
        ...
        cells: {
          admin: { label: 'все' },
          dp: { label: 'свои', hint: 'чужой комментарий удалить нельзя' },
          rp: { label: 'свои', hint: 'чужой комментарий удалить нельзя' },
          vp: { label: 'свои + в своих процессах', hint: 'свой — всегда; чужие — только в своих процессах' },
          worker: empty,
        },
      },
    ],
...
const ROLE_SUMMARIES: RoleSummary[] = [
  {
    ...
    permissions: [
      ...
      { title: 'Комментарии — все операции', description: 'Читает и создаёт комментарии ко всем задачам, удаляет любые комментарии.' },
  ...
  },
  {
    ...
    permissions: [
      ...
      { title: 'Комментарии — просмотр и создание', description: 'Читает и комментирует все задачи; удалять может только свои комментарии.' },
  ...
  },
  {
    ...
    permissions: [
      ...
      { title: 'Комментарии — просмотр и создание', description: 'Читает и комментирует задачи своих проектов; удаляет только свои комментарии.' },
  ...
  },
  {
    ...
    permissions: [
      ...
      { title: 'Комментарии — в своих процессах', description: 'Читает и создаёт комментарии к задачам своих процессов; свой комментарий удаляет всегда, чужие — только в своих процессах.' },
  ...
  },
  {
    ...
    permissions: [
      ...
      { title: 'Комментарии — недоступно', description: 'Не видит задачи, поэтому не может читать или писать комментарии.' },
