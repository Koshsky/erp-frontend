...
/** Полоска в половину ширины ячейки по центру дня; в тултипе — заголовок и описание */
...
/** Маркер на всю ширину ячейки вместо полоски */
export const CellVariant: Story = {
  render: withMilestone({
    date: iso(day(2, 8)),
    title: 'Контрольная точка',
    content: 'Промежуточная приёмка этапа работ',
    variant: 'cell',
  }),
}
