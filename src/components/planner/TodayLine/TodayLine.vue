...
.tl-line {
  ...
  top: 0;
  bottom: 0;
  /* Над контентом, шапкой календаря (30) и ячейками ресурсов (20), но под боковой
     панелью (65–80): коды ресурсов, merged/строчные лейблы, полоса вех и корнер
     остаются поверх линии текущей даты */
  z-index: 60;
  pointer-events: none;
}
</style>
